...
export default {
  ...
  "connect.verifying_body": "Verifying the link's signature against the OpenWork keys shipped with this app.",
  ...
  "connect.error_expired": "The connection link has expired. Ask your admin to send a fresh one.",
  "connect.error_unknown_kid": "This link was signed with a newer key than this app knows. Update OpenWork and try again.",
  "connect.error_replayed": "This connection link was already used on this machine. Ask your admin for a fresh one if you need to reconnect.",
