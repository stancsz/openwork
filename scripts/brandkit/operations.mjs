...
/** Build the full operation list for a loaded config. */
export function buildOperations(config) {
  const { brand, desktop, cloud, providers } = config;
  ...
  const ops = [
    ...
    { id: "asset:mark", type: "overwriteAsset", source: a.mark, target: "apps/app/public/openwork-mark.svg" },
    { id: "asset:logo", type: "overwriteAsset", source: a.logo, target: "apps/app/public/openwork-logo.svg" },
    { id: "asset:logo-square", type: "overwriteAsset", source: a.logoSquare, target: "apps/app/public/openwork-logo-square.svg" },
    { id: "asset:favicon-32", type: "overwriteAsset", source: a.favicon32, target: "apps/app/public/favicon-32x32.png" },
    { id: "asset:favicon-16", type: "overwriteAsset", source: a.favicon16, target: "apps/app/public/favicon-16x16.png" },
    { id: "asset:apple-touch", type: "overwriteAsset", source: a.appleTouchIcon, target: "apps/app/public/apple-touch-icon.png" },
    { id: "asset:desktop-png", type: "overwriteAsset", source: a.desktopIconPng, target: "apps/desktop/resources/icons/icon.png" },
    { id: "asset:desktop-ico", type: "overwriteAsset", source: a.desktopIconIco, target: "apps/desktop/resources/icons/icon.ico" },
    { id: "asset:desktop-icns", type: "overwriteAsset", source: a.desktopIconIcns, target: "apps/desktop/resources/icons/icon.icns" },
 ...
 */
function renderBrandViteConfig() {
